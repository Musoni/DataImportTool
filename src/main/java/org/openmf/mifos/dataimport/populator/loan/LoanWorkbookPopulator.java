...
//	        	CellRangeAddressList lintAccountIdRange = new CellRangeAddressList(1, SpreadsheetVersion.EXCEL97.getLastRowIndex(), LINK_ACCOUNT_ID, LINK_ACCOUNT_ID);
	        	...
	        	DataValidationConstraint repaymentStrategyConstraint = validationHelper.createExplicitListConstraint(new String[] {"Penalties Fees Interest Principal Order","Principal Interest Penalties Fees Order","Interest Principal Penalties Fees Order"});
